...
export default function Postproductservice() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const serviceId = await addDocument('services', payload)
          ...
          <div className="col-md-12 col-lg-12 col-xl-12 p-4">
            <form onSubmit={handleSubmit}>
              <div className="divider  mb-4 pb-2">
                <h1 className="fw-bold mb-0">Post a Product or Service</h1>
              </div>
                ...
                <div className="row mb-4">
                  ...
                  <div className="col-12 col-md-6 col-lg-3 mb-3">
                    <label className="btn btn-primary w-100 p-3">
                      <FontAwesomeIcon icon={faImage} className="mx-1" /> Upload
                      Images
                      <input
                        type="file"
                        className="d-none"
                  ...
                  <div className="col-12 col-md-6 col-lg-3 mb-3">
                    <label className="btn btn-warning w-100 p-3">
                      <FontAwesomeIcon icon={faMusic} className="mx-1" /> Upload
                      Audio
                      <input
                        type="file"
                        className="d-none"
                  ...
                  <div className="col-12 col-md-6 col-lg-3 mb-3">
                    <label className="btn btn-danger w-100 p-3">
                      <FontAwesomeIcon icon={faVideo} className="mx-1" />
                      Upload Video
                      <input
                        type="file"
                        className="d-none"
                  ...
                  <div className="col-12 col-md-6 col-lg-3 mb-3">
                    <label className="btn btn-success w-100 p-3">
                      <FontAwesomeIcon icon={faFile} className="mx-1" /> Upload
                      Documents
                      <input
                        type="file"
                        className="d-none"
              ...
              <div className="form-outline mb-4">
                <label className="form-label">
                  Business name/Trade/Profession/Occupation
                </label>
                <input
                  type="text"
                  className="form-control form-control-lg"
                  placeholder="Enter Business name/Trade/Profession/Occupation"
